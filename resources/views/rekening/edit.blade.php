...
@section('content')
    <div class="content">
        ...
        <div class="page-inner mt--5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('/rekening/'.$rekening->id) }}" method="POST">
                        @method('put')
                        @csrf
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rekening->nomor_rekening }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rekening->nama_rekening }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rekening->bank }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $rekening->saldo }}"
